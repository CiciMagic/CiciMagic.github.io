---
layout: post
title:  "Landscape-Based Approaches to Arid Photovoltaic Systems"
...
The [Nour Power Station in Morocco](https://www.wri.org/update/morocco-ensuring-large-scale-renewable-installation-benefits-local-communities), one of the world’s largest concentrated solar power plants, spans an area equal to 10 Central Parks. Built to reduce Morocco’s dependence on imported fossil fuels, it has supplied over a million homes with renewable energy since 2016.
...
![Before irrigation (top) and after irrigation (bottom)]({{site.baseurl}}/images/arid-pv-irrigation.jpg)
